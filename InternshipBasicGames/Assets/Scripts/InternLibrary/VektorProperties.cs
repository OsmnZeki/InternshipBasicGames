...
namespace InternLibrary.Vektors
{
    public class VektorProperties // TODO Vector
    {
        ...
        public static Borders ColliderIntersec(Vector2 from, Vector2 to, ObjectBounds[] objectBounds, ObjectBounds obj) // TO DO: Derinlemesine test edilmesi gerek
        {
            ...
            {
                point = AlignCenterPointToIntersectionPoint(to,from,foundedBorder,obj);
        ...
        public static ObjectBounds FoundCollidedGameObject(Vector2 from, Vector2 to, List<ObjectBounds> objectBounds, ObjectBounds obj)
        {
            ...
            Borders[] objBorders = obj.UpdateBorderAndReturn();
        ...
        /// </summary>
        public static Vector2 AlignCenterPointToIntersectionPoint(Vector2 to, Vector2 from, Borders foundedBorder, ObjectBounds obj)
        {
            // TODO interPoint kullanilmiyor ++
            Vector2 movementVector = to + from;
            var interPoint = LineIntersect(from, movementVector, foundedBorder.p1, foundedBorder.p2);
            float offsetY;
            float offsetX;
            if (to.y < 0)
            {
